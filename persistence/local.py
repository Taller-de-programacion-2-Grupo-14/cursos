...
class DB:
    ...
    def addCollaborator(self, collaborator):
        self.collaboratorsDB[collaborator["course_id"]] = self.collaboratorsDB.get(
            collaborator["course_id"], []
        ) + [collaborator["user_id"]]

    def removeCollaborator(self, collaborator):
        self.collaboratorsDB[collaborator["course_id"]].remove(
    ...
    def getCourseCollaborators(self, courseId):
        return (
            self.collaboratorsDB[courseId] if courseId in self.collaboratorsDB else []
        )
